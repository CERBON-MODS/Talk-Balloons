...
public final class BalloonRendererOld {
    ...
    *///?}
    ...
    public static void renderBalloons(PoseStack poseStack, MultiBufferSource bufferSource, Vector3f eulerCameraOrientation, Font font, HistoricalData<Component> messages, float playerHeight, SynchronizedConfigData configData) {
        ...
        *///?}
        ...
        var balloonTextureId = configData.balloonStyle();
        ...
        *///?}
        ...
        for (int i = 0; i < messages.size(); i++) {
            ...
            *///?}
            ...
            poseStack.translate(0.0, playerHeight + TalkBalloons.config.getBalloonsHeightOffset() - 0.4 + (padding / 32.0), 0.0D);
            ...
            *///?} else {
            ...
            List<FormattedCharSequence> dividedMessage = font.split(message, TalkBalloons.config.getMaxBalloonWidth());
            ...
            int balloonWidth = Mth.clamp(greatestTextWidth, TalkBalloons.config.getMinBalloonWidth(), TalkBalloons.config.getMaxBalloonWidth());
            ...
            if (previousBalloonHeight != 0)
                balloonDistance += 9 * previousBalloonHeight + TalkBalloons.config.getDistanceBetweenBalloons() + (padding * 2);
    ...
    public static Vector3f toEulerXyzDegrees(/*? if >= 1.20 {*/Quaternionf/*?} else {*//*Quaternion*//*?}*/ quaternionf) {
        Vector3f vec3f = BalloonRendererOld.toEulerXyz(quaternionf);
